  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {config.whatsapp_phone && (
        <a
          href={`https://wa.me/${config.whatsapp_phone.replace(/\D/g, "")}?text=Hola%20Contry%20Burger%2C%20quiero%20consultar%20sobre%20mi%20pedido`}
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-4 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-xl transition-transform hover:scale-110"
